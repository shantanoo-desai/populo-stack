 ...
 module.exports = {
     ...
     ******************************************************************************/
        ...
        adminAuth: {
           type: "credentials",
           users: [{
               username: process.env.NODERED_AUTH.slice(0, process.env.NODERED_AUTH.indexOf(':')),
               password: process.env.NODERED_AUTH.slice(process.env.NODERED_AUTH.indexOf(':')+1).replace("$2y$", "$2b$"),
               permissions: "*"
           }]
        },
     ...
     ******************************************************************************/
         ...
         */
        httpAdminRoot: process.env.NODERED_HTTP_ROOT || '/',
